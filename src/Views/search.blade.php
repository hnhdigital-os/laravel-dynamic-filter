...
<script src="{{ config('dynamic_filter.search_js_url', FrontendAsset::elixir('vendor/hnhdigital-os/laravel-dynamic-filter/search.js')) }}" defer></script>
@endif
<link rel="stylesheet" type="text/css" href="{{ config('dynamic_filter.search_js_url', FrontendAsset::elixir('vendor/hnhdigital-os/laravel-dynamic-filter/search.css')) }}" defer>
